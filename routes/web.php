...
Route::middleware(['auth', 'panel.role.access'])->group(function () {
    ...
    Route::post('kpi/structural-units/{unit}/records', [KpiStructuralUnitController::class, 'attachRecord'])
        ->name('kpi.structural-units.records.attach');
    Route::delete('kpi/structural-units/{unit}/records/{indicator}', [KpiStructuralUnitController::class, 'detachRecord'])
        ->name('kpi.structural-units.records.detach');
