    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="p-6 sm:p-8 max-w-5xl mx-auto space-y-6">
                ...
                <div className="space-y-3">
                    <Button variant="outline" size="sm" asChild className="w-fit">
                        <Link href={route('calendar.employees')}>
                            <ArrowLeft className="size-4 mr-2" />Назад к каталогу
                        </Link>
                    </Button>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{employee?.title || 'Без должности'}</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Alerts */}
                {!!flash?.warning && (
                    <div className="rounded-lg border border-amber-200 bg-amber-50 text-amber-800 px-4 py-3 text-sm font-medium">
                        {flash.warning}
                    </div>
                )}
                {!!flash?.success && (
                    <div className="rounded-lg border border-emerald-200 bg-emerald-50 text-emerald-800 px-4 py-3 text-sm font-medium">
                        {flash.success}
                    </div>
                )}
                ...
                <div className="space-y-2">
                    <h2 className="text-lg font-semibold text-foreground">Расписание на месяц</h2>
                    <MonthCalendar
                        year={year}
                        month={monthIdx}
                        events={events}
